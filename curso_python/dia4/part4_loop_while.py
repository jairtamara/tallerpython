...
while numero >=0:
    if numero % 5 ==0:
#        print(f"numero divisible por 5 es: {numero}")
        numero -=1
    else:           
        numero -=1
...
lista_numeros_indices  =  len(lista_numeros)

i = 0
while  lista_numeros_indices > 0 :
    
    if lista_numeros[i] > 0:
        print(f"tenemos un numero positivo {lista_numeros[i]}")
        i +=1
        lista_numeros_indices -=1
       
    else: 
        print(f"se termina ejecucion se detecto numero negativo {lista_numeros[i]}")  
        lista_numeros_indices -=1
        break
...
lista_numeros_1 = [4,5,8,7,6,9,8,2,4,5,7,1,9,5,6,-1,-5,6,-6,-4,-3]


for numero  in lista_numeros_1:
